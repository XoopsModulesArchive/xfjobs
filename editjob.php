...
$GLOBALS['xoopsOption']['template_main'] = 'xfjobs_editjob.html';
...
if ($group_id && '' != $group_id) {
    ...
    if ($add_job) {
        ...
        */
        ...
        if (!$valid) {
            ...
            $loc = XOOPS_URL . '/modules/xfjobs/createjob.php' . "?group_id=$group_id&job_id=$job_id&title=$title" . "&category_id=$category_id&description=$description" . "&feedback=$feedback&fromedit=1";
        ...
        */
        ...
        if (people_verify_job_group($job_id, $group_id)) {
            $sql = 'UPDATE ' . $xoopsDB->prefix('xf_people_job_inventory') . ' SET ' . "skill_level_id='$skill_level_id'," . "skill_year_id='$skill_year_id' " . "WHERE job_id='$job_id' " . "AND job_inventory_id='$job_inventory_id'";
        ...
        */
        ...
        if (people_verify_job_group($job_id, $group_id)) {
            $sql = 'DELETE FROM ' . $xoopsDB->prefix('xf_people_job_inventory') . " WHERE job_id='$job_id' " . "AND job_inventory_id='$job_inventory_id'";
    ...
    */
    ...
    $sql = 'SELECT * FROM ' . $xoopsDB->prefix('xf_people_job') . " WHERE job_id='$job_id' AND group_id='$group_id'";
    ...
    if (!$result) {
        ...
        $content .= people_job_category_box(
            'category_id',
        ...
        $content .= '<INPUT TYPE="TEXT" NAME="title" VALUE="' . $ts->htmlSpecialChars(
        ...
        $content .= '<TEXTAREA NAME="description" ROWS="10" COLS="60" WRAP="SOFT">' . $ts->displayTarea(
            unofficial_getDBResult(
                    $result,
                    0,
                    'description'
        ...
        $content .= '<P><FORM ACTION="' . XOOPS_URL . '/modules/xfjobs/" METHOD="POST">
